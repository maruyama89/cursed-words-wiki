...
## 使い方
- 「出典」には、どのページのどのテキストで見た単語かをリンクする（後で文脈を思い出せるように）
- ゲーム特有の意味がある場合（例: Tile, Grid）は[glossary/index.md](../glossary/index.md)を参照。ここは一般的な英語学習として意味のある語のみ載せる
- 自信がない訳・ニュアンスには「（要確認）」を付ける
...
| consecutive | 連続した | 形容詞 | [Alembic Flaskの効果文](../items/index.md) | "consecutive numbers" = 連番、連続する数字 |
| alembic | 蒸留器（錬金術・化学で使う器具） | 名詞 | [Alembic Flask（アイテム名）](../items/index.md) | やや古語・専門語。ファンタジー系アイテム名でよく使われる |
| vizor | バイザー、（兜などの）面覆い（= visor の異表記） | 名詞 | [Waxy Vizor（アイテム名）](../items/index.md) | 一般的な綴りは "visor"。ゲーム内表記は "Vizor"（要確認：意図的な当て字か単なる表記ゆれか） |
| currency / currencies | 通貨 | 名詞 | [Bankの効果文](../items/index.md) | currency の複数形は currencies（yと同様、子音+yはiesに変化） |
| unique | 唯一の、独自の | 形容詞 | ゲーム内レアリティ表記 UNIQUE | ここではレアリティ区分の固有名詞として使われている |
| doubled | 2倍になった | 動詞(過去分詞) | [Avocadoの効果文](../items/index.md) | double（2倍にする）の過去分詞。"prices are doubled" は受動態 |

---

## 意味不明・要調査の語（ゲーム内造語の可能性）
- **splanshgy**（[Rodmanのキャラ説明](../characters/index.md#rodmanロッドマン)）: 一般的な英単語ではない。"splashy"（はねる、派手な）と"squishy/sploshy"（ぬちゃっとした）の混成語か、単なるタイポの可能性（要確認）
